...
def chat_sp():
    ...
    while a:
        ...
        if result == None :
            ans3=input("can you specify more or tap q to quit")
            if ans3=="q":
                a=False
            else:
                continue
            ...
            an=input("From how many days, are you feeling those symptoms?")
            if calc_condition(sym,int(an))==1:
                ...
                for e in precautionDictionary[result[0]]:
                    print(e)
            print("do you need any another medical consultation (yes or no)? ")
            ans=input()
            if ans!="yes":
                a=False
